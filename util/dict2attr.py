...
refine_param = [ 'normalize_percentile', 'batch_normalization', 'filter_base', 'unet_depth', 'pool', 'kernel', 'convs_per_depth', 'drop_out','noise_dir', 
                ...
                'select_subtomo_number','remove_intermediate','prefill', 'probability','arch','low_mem','use_wandb','wandb_project','wandb_run_name','wandb_entity']
predict_param = ['tomo_idx', 'Ntile', 'log_level', 'normalize_percentile', 'batch_size', 'use_deconv_tomo', 'crop_size', 'cube_size', 'gpuID', 'output_dir', 'model', 'star_file', 'arch']
